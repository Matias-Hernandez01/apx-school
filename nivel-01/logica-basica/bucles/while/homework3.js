//En base a este carrito de compras utilizá un while para calcular el monto total. Tené en cuenta que cada ítem
//tiene un precio y una cantidad, por lo que tendrás que multiplicar precio * cantidad en cada ítem.
...
while (indice < carrito.length) {
  ...
  const totalPorItem = carrito[indice].precio * carrito[indice].cantidad;
  
  totalDelCarrito += totalPorItem;
  indice++;
}
